...
config.runtimeDataModel = JSON.parse("{\"models\":{\"VisionBoard\":{\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"name\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"photo_url\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"message\",\"kind\":\"scalar\",\"type\":\"String\"}],\"dbName\":\"vision_boards\"}},\"enums\":{},\"types\":{}}")
...
/**
   ...
   * `prisma.visionBoard`: Exposes CRUD operations for the **VisionBoard** model.
    ...
    * ```
    */
  get visionBoard(): Prisma.VisionBoardDelegate<ExtArgs, { omit: OmitOpts }>;
}
